                ...
                <div class="col-lg-12">
                    <div class="position-relative newsletter-inner">
                        <div class="newsletter-content">
                            <h2 class="mb-20">
                                Reserve lab materials & equipment <br />
                                easily from our system
                            </h2>
                            <p class="mb-45">Start reserving your lab materials with <span class="text-brand">UPTC RIDS</span></p>
                        </div>
                        <img src="assets/imgs/banner/lab-reserve-banner.png" alt="newsletter" />
                    </div>
                </div>
            </div>
</div>
